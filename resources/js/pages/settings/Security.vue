    ...
    <div class="space-y-6">
        ...
        <Form v-bind="SecurityController.update.form()" :options="{
            ...
            <div class="grid gap-2">
                ...
                <PasswordInput id="password" name="password" class="mt-1 block w-full" autocomplete="new-password"
                    placeholder="New password" :passwordrules="props.passwordRules" />
            ...
            <div class="grid gap-2">
                ...
                <PasswordInput id="password_confirmation" name="password_confirmation" class="mt-1 block w-full"
                    autocomplete="new-password" placeholder="Confirm password" :passwordrules="props.passwordRules" />
