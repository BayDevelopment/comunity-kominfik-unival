...
<!-- Header gradient -->
<tr>
<td style="background-color:#f97316; background:linear-gradient(135deg,#f97316,#fbbf24); padding:32px 40px; text-align:center;">
...
<td style="padding:40px;">
    ...
    <p style="margin:0 0 28px; font-size:14px; line-height:1.7; color:#334155;">
        Terima kasih atas pengajuan kerjasama dari <strong>{{ $kerjasama->nama_instansi }}</strong> kepada KOMINFIK. Pengajuan kamu sudah kami terima dan akan segera ditinjau oleh tim kami.
    </p>
    ...
    <td style="padding:24px;">
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
            <tr>
                <td style="padding:8px 0; font-size:13px; color:#78716c; width:40%;">Nama Instansi</td>
                <td style="padding:8px 0; font-size:13px; color:#0f172a; font-weight:700;">{{ $kerjasama->nama_instansi }}</td>
            </tr>
            <tr>
                <td style="padding:8px 0; font-size:13px; color:#78716c; border-top:1px solid #ffedd5;">Jenis Instansi</td>
                <td style="padding:8px 0; font-size:13px; color:#0f172a; font-weight:700; border-top:1px solid #ffedd5; text-transform:capitalize;">{{ $kerjasama->jenis_instansi }}</td>
            </tr>
            <tr>
                <td style="padding:8px 0; font-size:13px; color:#78716c; border-top:1px solid #ffedd5;">Nama PIC</td>
                <td style="padding:8px 0; font-size:13px; color:#0f172a; font-weight:700; border-top:1px solid #ffedd5;">{{ $kerjasama->nama_pic }}</td>
            </tr>
            @if($kerjasama->jabatan_pic)
            <tr>
                <td style="padding:8px 0; font-size:13px; color:#78716c; border-top:1px solid #ffedd5;">Jabatan PIC</td>
                <td style="padding:8px 0; font-size:13px; color:#0f172a; font-weight:700; border-top:1px solid #ffedd5;">{{ $kerjasama->jabatan_pic }}</td>
            </tr>
            @endif
            <tr>
                <td style="padding:8px 0; font-size:13px; color:#78716c; border-top:1px solid #ffedd5;">Email PIC</td>
                <td style="padding:8px 0; font-size:13px; color:#0f172a; font-weight:700; border-top:1px solid #ffedd5;">{{ $kerjasama->email_pic }}</td>
            </tr>
            <tr>
                <td style="padding:8px 0; font-size:13px; color:#78716c; border-top:1px solid #ffedd5;">No. HP PIC</td>
                <td style="padding:8px 0; font-size:13px; color:#0f172a; font-weight:700; border-top:1px solid #ffedd5;">{{ $kerjasama->no_hp_pic }}</td>
            </tr>
            @if($kerjasama->jenis_kerjasama)
            <tr>
                <td style="padding:8px 0; font-size:13px; color:#78716c; border-top:1px solid #ffedd5;">Jenis Kerjasama</td>
                <td style="padding:8px 0; font-size:13px; color:#0f172a; font-weight:700; border-top:1px solid #ffedd5;">{{ $kerjasama->jenis_kerjasama }}</td>
            </tr>
            @endif
        </table>
    </td>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#fafaf9; border:1px solid #f1f5f9; border-radius:16px; margin-bottom:28px;">
    <tr>
    <td style="padding:20px 24px;">
        <p style="margin:0 0 8px; font-size:11px; font-weight:900; text-transform:uppercase; letter-spacing:0.08em; color:#78716c;">
            Deskripsi Kerjasama
        </p>
    ...
    <p style="margin:0 0 28px; font-size:14px; line-height:1.7; color:#334155;">
        Tim kami akan menghubungi PIC melalui email atau nomor HP yang tercantum setelah proses peninjauan selesai. Mohon pantau kotak masuk (dan folder spam) secara berkala.
    </p>
