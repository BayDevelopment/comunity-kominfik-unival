...
<template>
    ...
    <div class="mx-auto max-w-4xl px-6 py-8">
        <div class="mb-8">
            ...
            <h1 class="text-2xl font-black text-slate-950">Edit Template Sertifikat</h1>
        ...
        <form @submit.prevent="submit" class="space-y-6 rounded-[2rem] border border-orange-100 bg-white p-8 shadow-sm">
            ...
            <div class="pt-2 border-t border-slate-100">
                <label class="block text-sm font-bold text-slate-900 mb-2 mt-4">Ganti Gambar Latar Belakang (Opsional)</label>

                <div v-if="template.background_url && !form.background_image" class="mb-3 flex items-center gap-4 rounded-xl border border-slate-200 p-3 bg-slate-50">
                    <img :src="template.background_url" alt="Current Background" class="h-16 w-28 object-cover rounded-lg border border-slate-200" />
                    <div>
                        <p class="text-xs font-bold text-slate-700">Latar belakang saat ini terpasang</p>
                        <p class="text-[10px] text-slate-400">Unggah file baru di bawah jika ingin menggantinya.</p>
                    </div>
                </div>

                <div class="flex items-center justify-center w-full">
                    <label class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-orange-200 rounded-2xl cursor-pointer bg-orange-50/50 hover:bg-orange-50 transition">
                        <div class="flex flex-col items-center justify-center pt-5 pb-6 px-4 text-center">
                            <Upload class="w-7 h-7 mb-2 text-orange-500" />
            ...
            <div class="flex items-center gap-3 pt-4 border-t border-slate-100">
                ...
                />
                <label for="is_active" class="text-sm font-bold text-slate-900">Aktifkan template ini</label>
            </div>
