    ...
    layout: {
        breadcrumbs: [
            ...
            },
            {
                ...
                href: '/pendaftaran-kerjasama/create',
            },
        ],
    },
});
...
function submit() {
    form.post('/pendaftaran-kerjasama', {
        forceFormData: true,
        preserveScroll: true,
    });
}
    ...
    <div class="space-y-6 p-6">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-2xl font-bold">Tambah Kerjasama</h1>
                    <p class="text-sm text-muted-foreground">
                        Lengkapi data pengajuan kerjasama instansi.
                    </p>
                </div>
            </div>
        </div>
        ...
        <form class="space-y-6" @submit.prevent="submit">
            ...
            <div class="rounded-xl border bg-background p-6 shadow-sm">
                <div class="mb-5">
                    ...
                    <p class="text-xs text-muted-foreground">
                        Unggah proposal dan/atau draft MoU (opsional)
                    </p>
                </div>
