...
<template>
    <PublicLayout>
        <main class="overflow-hidden bg-white">
            ...
            <section
                id="beranda"
                class="relative scroll-mt-28 bg-gradient-to-b from-orange-50 via-white to-white"
            >
                <div
                    class="absolute top-20 -left-24 h-72 w-72 rounded-full bg-orange-200/50 blur-3xl"
                ></div>
                <div
                    class="absolute top-10 -right-24 h-80 w-80 rounded-full bg-amber-200/50 blur-3xl"
                ></div>
                ...
                >
                    <div>
                        ...
                        <h1
                            class="max-w-3xl text-4xl leading-tight font-black tracking-tight text-slate-950 md:text-6xl"
                        >
                            Bangun Ekosistem Digital Bersama
                            <span
                                class="bg-gradient-to-r from-orange-500 to-amber-500 bg-clip-text text-transparent"
                            >
                                KOMINFIK
                            </span>
                        </h1>
                        ...
                        >
                            KOMINFIK menjadi wadah kolaborasi untuk mahasiswa,
                            anggota komunitas, perusahaan, dan universitas dalam
                            pengembangan teknologi, kreativitas, serta inovasi
                            digital.
                        </p>
                    ...
                    <div class="relative">
                        ...
                        >
                            ...
                            >
                                ...
                                <div
                                    ...
                                    style="
                                        background-image:
                                            ...
                                            radial-gradient(
                                                1px 1px at 90px 80px,
                                                white,
                                                transparent
                                            ),
                                            radial-gradient(
                                                1px 1px at 150px 20px,
                                                white,
                                                transparent
                                            ),
                                            radial-gradient(
                                                1.5px 1.5px at 50px 120px,
                                                white,
                                                transparent
                                            ),
                                            radial-gradient(
                                            ...
                                            radial-gradient(
                                                1.5px 1.5px at 220px 60px,
                                                white,
                                                transparent
                                            ),
                                            radial-gradient(
                                                1px 1px at 260px 110px,
                                                white,
                                                transparent
                                            ),
                                            radial-gradient(
                                                1px 1px at 10px 160px,
                                                white,
                                                transparent
                                            );
                                ...
                                <!-- Nebula glow -->
                                <div
                                    class="pointer-events-none absolute -top-10 -right-10 h-40 w-40 rounded-full bg-orange-500/20 blur-3xl"
                                ></div>
                                <div
                                ...
                                <div class="relative z-10">
                                    ...
                                    <div class="mt-6 space-y-4">
                                        <div class="rounded-2xl bg-white/10 p-4 backdrop-blur">
                                            ...
                                            <!-- Progress bar dengan fallback || 0 agar tidak full saat kosong -->
                                            <div class="mt-3 h-2 overflow-hidden rounded-full bg-white/10">
                                                <div
                                                    class="h-2 rounded-full bg-gradient-to-r from-orange-500 to-amber-400 transition-all duration-500"
                                            ...
                                            <div class="mt-2 flex items-center justify-between text-xs text-slate-300">
                                                ...
                                                <span class="font-bold text-orange-300">{{ stats.avg_progress || 0 }}%</span>
                                            </div>
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            <div
                                                class="rounded-2xl bg-orange-500 p-4"
                                            >
                                                <p
                                                    class="text-xs font-bold text-orange-100"
                                                >
                                                    Kerjasama
                                                </p>
                                                <h4
                                                ...
                                                >
                                                    {{
                                                        formatCount(stats.mitra)
                                                    }}
                                                </h4>
                                            </div>

                                            <div
                                                class="rounded-2xl bg-amber-400 p-4 text-slate-950"
                                            >
                                                <p
                                                    class="text-xs font-bold text-amber-900/70"
                                                >
                                                    Layanan
                                                </p>
                                                <h4
            ...
            <section id="project" class="scroll-mt-28 px-6 py-20">
                <div class="mx-auto max-w-7xl">
                    <div class="max-w-2xl">
                        ...
                        <h2
                            class="mt-3 text-3xl font-black tracking-tight text-slate-950 md:text-4xl"
                        >
                            Project digital yang bisa dikembangkan bersama
                        </h2>

                        <p class="mt-4 text-slate-600">
                            KOMINFIK membuka ruang kolaborasi untuk membuat
                            produk digital yang bermanfaat, modern, dan sesuai
                            kebutuhan pengguna.
                        </p>
                    </div>
                    ...
                    <div
                        v-else
                        class="mt-10 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3"
                    >
                        <article
                        ...
                        >
                            <!-- Gambar project -->
                            <div
                                class="relative h-44 w-full overflow-hidden bg-orange-50"
                            >
                                <img
                                    v-if="project.gambar_url"
                                ...
                                <div
                                    v-else
                                    class="flex h-full w-full items-center justify-center text-orange-300"
                                >
                                    <ImageOff
                                        class="h-8 w-8"
                                        stroke-width="1.8"
                                ...
                                <span
                                    class="absolute top-3 right-3 rounded-full px-3 py-1 text-xs font-bold ring-1 ring-inset"
                            ...
                            <div class="p-6">
                                ...
                                <div class="mt-5">
                                    ...
                                    <div
                                        class="mt-2 h-2 rounded-full bg-orange-50"
                                    >
                                        <div
                                            class="h-2 rounded-full bg-gradient-to-r from-orange-500 to-amber-400"
                                            :style="{
            ...
            <section
                id="anggota"
                class="relative scroll-mt-28 overflow-hidden bg-orange-50/60 px-6 py-20"
            >
                <div
                    class="absolute top-10 -left-24 h-72 w-72 rounded-full bg-orange-200/40 blur-3xl"
                ></div>
                <div
                    class="absolute -right-24 bottom-10 h-72 w-72 rounded-full bg-amber-200/40 blur-3xl"
                ></div>
                ...
                <div class="relative mx-auto max-w-7xl">
                    ...
                    >
                        <div class="max-w-2xl">
                            ...
                            <p class="mt-5 leading-8 text-slate-600">
                                Anggota KOMINFIK terdiri dari mahasiswa dengan
                                berbagai skill digital, mulai dari pengembangan
                                website, desain UI/UX, content creator, hingga
                    ...
                    <div
                        v-else
                        ref="membersCarousel"
                        class="mt-10 flex snap-x snap-mandatory [scrollbar-width:none] gap-5 overflow-x-auto scroll-smooth pb-4 [&::-webkit-scrollbar]:hidden"
                    >
                        <article
                            v-for="member in anggotas"
                            :key="member.id"
                        ...
                        >
                            <div
                                class="relative h-72 overflow-hidden bg-orange-100"
                            >
                                <img
                                ...
                                <div
                                    class="absolute top-5 left-5 rounded-full bg-white/90 px-4 py-2 text-xs font-black text-orange-700 shadow-sm backdrop-blur"
                                >
                                ...
                                <div class="absolute right-5 bottom-5 left-5">
                                    ...
                                    <p
                                        v-if="member.divisi"
                                        class="mt-1 text-sm font-semibold text-orange-100"
                                    >
                                        {{ member.divisi }}
                                    </p>
                                </div>
                    ...
                    >
                        <div>
                            ...
                            <p class="mt-1 text-sm text-slate-500">
                                Gabung bersama anggota lain dan bangun
                                portofolio digitalmu.
                            </p>
                        </div>
                ...
                <div class="mx-auto max-w-7xl">
                    <div class="text-center">
                        ...
                        <p class="mx-auto mt-4 max-w-2xl text-slate-600">
                            Kami membantu kebutuhan digital melalui pendekatan
                            kolaboratif, kreatif, dan profesional.
                        </p>
                    </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                v-if="layanan.gambar_url"
                                class="h-40 w-full overflow-hidden bg-orange-50"
                            >
                                <img
                                    :src="layanan.gambar_url"
                                    :alt="layanan.nama"
                                    class="h-full w-full object-cover transition duration-500 group-hover:scale-105"
                                />
                            </div>
                            ...
                            <div class="p-6">
                                ...
                                >
                                    <component
                                        :is="getServiceIcon(layanan.kategori)"
                                        class="h-7 w-7"
                                        stroke-width="2.4"
                                    />
                                </div>
                                ...
                                <h3
                                    class="mt-2 text-lg font-black text-slate-950"
                                >
                                    {{ layanan.nama }}
                                </h3>

                                <p
                                    v-if="layanan.deskripsi"
                                    class="mt-3 line-clamp-3 text-sm leading-7 text-slate-500"
                                >
                                    {{ layanan.deskripsi }}
                                </p>
                                ...
                                <div
                                    v-if="
                                        layanan.syarat && layanan.syarat.length
                                    "
                                ...
                                >
                                    ...
                                    <ul
                                        class="mt-2 space-y-1.5 text-sm text-slate-600"
                                    >
                                        <li
                                            v-for="(
                                                syarat, index
                                            ) in layanan.syarat.slice(0, 3)"
                                            :key="index"
                                            class="flex items-start gap-2"
                                        >
                                            <span
                                                class="mt-1.5 h-1 w-1 shrink-0 rounded-full bg-orange-400"
                                            ></span>
                                            <span>{{ syarat }}</span>
                                        </li>
                                    </ul>
                                    <p
                                        v-if="layanan.syarat.length > 3"
                                        class="mt-1.5 text-xs font-semibold text-orange-500"
                                    >
                                        +{{ layanan.syarat.length - 3 }} syarat
                                        lainnya
                                    </p>
                                </div>

                                <div
                                    class="mt-5 flex flex-wrap items-center gap-2 text-xs font-bold"
                                >
                                    <span
                                        v-if="layanan.estimasi_waktu"
                                        class="rounded-full bg-slate-50 px-3 py-1.5 text-slate-500"
                                    >
                                        ⏱ {{ layanan.estimasi_waktu }}
                                    </span>
                                    <span
                                        class="rounded-full bg-orange-50 px-3 py-1.5 text-orange-700"
                                    >
                                        {{
                    ...
                    >
                        ...
                        >
                            <div>
                                ...
                                <p
                                    class="mt-4 max-w-xl leading-8 text-orange-50"
                                >
                                    Kami terbuka untuk kerjasama project
                                    digital, pelatihan teknologi, kegiatan
                                    kampus, komunitas, perusahaan, dan
                                    organisasi.
                                </p>
                            </div>
