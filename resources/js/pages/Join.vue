            ...
            <section class="scroll-mt-28 px-6 pb-24">
                <div class="mx-auto grid max-w-7xl grid-cols-1 gap-6 md:grid-cols-3">
                    <article v-for="option in options" :key="option.id"
                        ...
                        <!-- Badge status (Sudah diamankan dengan option.periode?.status) -->
                        ...
                        <div v-if="option.periode && (option.periode.tanggal_mulai || option.periode.tanggal_selesai)"
                            ...
                            <span>
                                {{ formatDate(option.periode.tanggal_mulai) }} – {{ formatDate(option.periode.tanggal_selesai) }}
                            </span>
                        </div>
                        ...
                        <!-- CTA: aktif kalau periode dibuka, disabled kalau ditutup (Sudah diamankan dengan option.periode?.status) -->
