    ...
    layout: {
        breadcrumbs: [
            ...
            },
            {
                ...
                href: '/periode-pendaftaran/create',
            },
        ],
    },
});
...
<template>
    ...
    <Head title="Tambah Periode Pendaftaran" />
    ...
    <div class="mx-auto max-w-2xl space-y-6 p-6">
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-2xl font-bold">Tambah Periode Pendaftaran</h1>
                <p class="text-sm text-muted-foreground">
                    Buat periode baru untuk pendaftaran anggota atau kerjasama.
                </p>
            </div>
        </div>
