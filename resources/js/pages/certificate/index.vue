...
// State untuk Custom Modal Cabut Sertifikat
const showRevokeModal = ref(false);
const selectedCertificate = ref<CertificateRow | null>(null);
const revokeReason = ref('');

// State untuk Custom Modal Hapus Sertifikat
...
<template>
    ...
    <div class="space-y-6 p-4 sm:p-6">
        ...
        >
            ...
            <div
                class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:flex lg:w-auto"
            >
                <select
            ...
            <div class="overflow-x-auto">
                <table class="w-full min-w-[900px] text-left text-sm">
                    ...
                    <tbody class="divide-y">
                        ...
                        >
                            <td
                                class="px-6 py-4 font-mono text-xs font-bold text-foreground"
                            >
                            ...
                            <td class="px-6 py-4">
                                ...
                                >
                                    ...
                                    <a
                                        :href="`/certificate/${item.id}/download`"
                                        target="_blank"
                        ...
                        <tr v-if="certificates.data.length === 0">
                            <td colspan="7" class="px-6 py-16 text-center">
                                ...
                                <p class="mt-1 text-xs text-muted-foreground">
                                    Coba ubah filter, atau terbitkan sertifikat
                                    baru.
                                </p>
                            </td>
                        </tr>
            ...
            >
                ...
                <div class="flex flex-wrap items-center gap-1">
                    ...
                    >
                        ...
                        <ChevronRight
                            v-else-if="index === certificates.links.length - 1"
                            class="h-3.5 w-3.5"
                        />
        ...
        >
            ...
            >
                ...
                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                    Masukkan alasan mengapa sertifikat
                    <span
                        class="font-semibold text-slate-700 dark:text-slate-200"
                        >{{ selectedCertificate?.certificate_number }}</span
                    >
                    ini dicabut:
                </p>
                ...
                <div class="mt-6 flex items-center gap-3">
                    <button
                        ...
                        "
                        type="button"
                        class="flex-1 rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-bold text-slate-700 transition hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
                    >
                        Batal
                    </button>
                    <button
