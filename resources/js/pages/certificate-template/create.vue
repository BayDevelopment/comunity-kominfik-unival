...
<template>
    ...
    <div class="mx-auto max-w-4xl px-6 py-8">
        <div class="mb-8">
            ...
            <h1 class="text-2xl font-black text-slate-950 dark:text-white">Buat Template Sertifikat</h1>
        ...
        <form @submit.prevent="submit" class="space-y-6 rounded-[2rem] border border-orange-100 bg-white p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            ...
            <div>
                <label class="block text-sm font-bold text-slate-900 mb-2 dark:text-slate-200">File Latar Belakang (Background)</label>
                <div class="flex items-center justify-center w-full">
                    <label class="flex flex-col items-center justify-center w-full h-36 border-2 border-dashed border-orange-200 rounded-2xl cursor-pointer bg-orange-50/50 hover:bg-orange-50 transition dark:border-orange-900/50 dark:bg-slate-800/40 dark:hover:bg-slate-800/80">
            ...
            <div class="flex items-center gap-3 pt-4 border-t border-slate-100 dark:border-slate-800">
                ...
                />
                <label for="is_active" class="text-sm font-bold text-slate-900 dark:text-slate-200">Aktifkan template ini segera</label>
            </div>
