    ...
    <div class="mx-auto max-w-2xl space-y-6 p-6">
        ...
        <form @submit.prevent="submit" class="space-y-6 rounded-xl border bg-background p-6 shadow-sm">
            ...
            <div
                ...
                <span>
                    Akun ini memiliki peran <b>Pengurus</b> dan bisa login untuk mengelola website.
                </span>
            </div>
            ...
            <div class="space-y-1.5">
                ...
                <p v-if="form.email !== user.email" class="text-xs text-amber-600 dark:text-amber-400">
                    Mengubah email akan menandai akun sebagai belum terverifikasi kembali.
                </p>
            </div>

            <!-- Password -->
            <div class="space-y-1.5 border-t pt-5">
            ...
            <div v-if="form.password" class="space-y-1.5">
                ...
                <div class="relative">
                    ...
                    <input id="password_confirmation" v-model="form.password_confirmation"
                        :type="showPasswordConfirmation ? 'text' : 'password'" placeholder="Ulangi kata sandi baru"
